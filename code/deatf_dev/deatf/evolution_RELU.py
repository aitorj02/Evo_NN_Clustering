...
from network_RELU import MLP, MLPDescriptor, TCNN, CNN, RNN
from mutation_RELU import MLP_Mutation, CNN_Mutation, TCNN_Mutation, RNN_Mutation
import os
...
class Evolving:
    ...
    * Optional atributes: atributes that are not needed, it can be initialiced without
    ...
    def evolve(self):
        ...
        #print("Internal", self.generations,self.population_size,self.iters) 
